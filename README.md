...
Веб-интерфейс платформы выставок животных **ShowTail**: каталог собак, питомников и помётов,
...
Бэкенд — FastAPI-сервис ShowTail.
...
(`BACKEND_URL`, по умолчанию `http://localhost:8000`). Запусти бэкенд ShowTail локально,
